...
const CardDetails = () => {
  ...
  const materialOptions = parsedProduct?.materials ? Object.keys(parsedProduct.materials) : ["PVC", "Metal", "Wood"];
  ...
  const getPrice = () => {
    const unitPrice = parsedProduct?.materials?.[selectedMaterial]?.price_per_unit || 1200;
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.imageContainer}>
          <Image
            source={{ uri: parsedProduct?.front_image || "https://via.placeholder.com/300" }} 
